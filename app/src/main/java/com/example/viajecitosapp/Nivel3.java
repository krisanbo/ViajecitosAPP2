...
public class Nivel3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int puntosInt = getIntent().getIntExtra("puntos", 20);
        if (puntosInt == 20) {
            tv_score.setText("20");
        } else {
        ...
        int america_bandera[] = {R.drawable.argelia, R.drawable.egipto, R.drawable.kenya, R.drawable.sudafrica, R.drawable.tunez};
        africa.add("Argelia");
        africa.add("Egipto");
        africa.add("Kenya");
        africa.add("Sudafrica");
        africa.add("Tunez");

        int n_bandera = numeroAleatorio("pais", africa.size());
        ArrayList<Integer> elegido = new ArrayList<Integer>();
        elegido.add(n_bandera);

        int i = 1;
        while (i < 5) {
            n_bandera = numeroAleatorio("pais", africa.size());
        ...
        respuesta.setText(africa.get(elegido.get(0)));

        int posicion_rb = numeroAleatorio("rb", 3);

        if (posicion_rb == 1) {
            rb_opcion1.setText(africa.get(elegido.get(0)));
            rb_opcion2.setText(africa.get(elegido.get(1)));
            rb_opcion3.setText(africa.get(elegido.get(2)));

        } else if (posicion_rb == 2) {
            rb_opcion1.setText(africa.get(elegido.get(2)));
            rb_opcion2.setText(africa.get(elegido.get(0)));
            rb_opcion3.setText(africa.get(elegido.get(1)));

        } else if (posicion_rb == 3) {
            rb_opcion1.setText(africa.get(elegido.get(1)));
            rb_opcion2.setText(africa.get(elegido.get(2)));
            rb_opcion3.setText(africa.get(elegido.get(0)));
    ...
    public void comprobar(View view) {
        ...
        if (correcta.equals(seleccion)) {
            ...
            nivel3.putExtra("puntos", scoreInt);
            nivel3.putExtra("nvidas", vidasInt);
            nivel3.putExtra("nombre",viajero);
            ...
            if (scoreInt == 30) {
                ...
                Intent siguiente2 = new Intent(this, com.example.viajecitosapp.Nivel4.class);
                siguiente2.putExtra("nombre", tv_nombre.getText().toString());
                siguiente2.putExtra("puntos", tv_score.getText().toString());
