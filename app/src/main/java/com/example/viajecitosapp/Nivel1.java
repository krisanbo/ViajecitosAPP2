...
public class Nivel1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        respuesta.setText(europa.get(elegido.get(0)));
    ...
    public void comprobar(View view) {
        ...
        if (correcta.equals(seleccion)) {
            ...
            nivel1.putExtra("nvidas", vidasInt);
            nivel1.putExtra("nombre",viajero);
            ...
            if (scoreInt == 10) {
                ...
                Intent siguiente = new Intent(this, com.example.viajecitosapp.Nivel2.class);
                siguiente.putExtra("nombre", tv_nombre.getText().toString());
                siguiente.putExtra("puntos", tv_score.getText().toString());
                siguiente.putExtra("nvidas", tv_vidas.getText().toString());
